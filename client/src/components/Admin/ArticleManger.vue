...
<div id="ArticleManger">
  ...
  >
    ...
    <el-table-column
        ...
        label="操作">
      <template #default="scope">
        <el-button type="primary" @click="update(scope.row._id,{title:scope.row.title,des:scope.row.des})" size="small">修改</el-button>
        <el-button type="danger" @click="deleteArticle(scope.row)" size="small">删除</el-button>
      </template>
    </el-table-column>
  </el-table>
</div>
